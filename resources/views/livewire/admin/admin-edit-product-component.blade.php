            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        @endif
                        <form class="form-horizontal" action="" enctype="multipart/form-data" wire:submit.prevent="updateProduct">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="file" class="input-file input-md" wire:model="newimage" />
                                    @if($newimage)
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="submit" value="Update" class="btn btn-primary input-md" />
                                </div>
                            </div>
                        </form>
                    </div>
