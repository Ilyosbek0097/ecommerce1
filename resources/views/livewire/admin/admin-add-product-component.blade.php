           ...
           <div class="col-md-12">
               <div class="panel panel-default">
                   ...
                   <div class="panel-body">
                       ...
                       @endif
                       <form class="form-horizontal" action="" enctype="multipart/form-data" wire:submit.prevent="addProduct">
                           ...
                           <div class="form-group">
                               ...
                               <div class="col-md-4">
                                   <input type="submit" value="Submit" class="btn btn-primary input-md" />
                               </div>
                           </div>
                       </form>
                   </div>
