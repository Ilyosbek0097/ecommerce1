                ...
                <div class="wrap-product-detail">
                    ...
                    <div class="detail-info">
                        ...
                        <div class="stock-info in-stock">
                            <p class="availability">Availability: <b class="text-capitalize">{{$product->stock_status}}</b></p>
                        </div>
                        <div class="quantity">
                            <span>Quantity:</span>
                                ...
                                <li class="product-item">
                                    <div class="product product-widget-style">
                                        ...
                                        <div class="product-info">
                                            <a href="{{ route('product.details', ['slug' => $popular_product->slug]) }}" class="product-name text-capitalize"><span>{{ $popular_product->name }}</span></a>
                        ...
                        <div class="products slide-carousel owl-carousel style-nav-1 equal-container" data-items="5" data-loop="false" data-nav="true" data-dots="false" data-responsive='{"0":{"items":"1"},"480":{"items":"2"},"768":{"items":"3"},"992":{"items":"3"},"1200":{"items":"5"}}' >
                            @foreach($related_products as $r_product)
                                <div class="product product-style-2 equal-elem ">
                                    ...
                                    <div class="product-info">
                                        <a href="{{ route('product.details', ['slug' => $r_product->slug]) }}" class="product-name text-capitalize"><span>{{ $r_product->name }}</span></a>
